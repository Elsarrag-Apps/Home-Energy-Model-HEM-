...
def apply_thermal_bridges_to_case(
    ...
    HEM accepts ThermalBridging as a single float. For this first connected
    implementation, we use the total thermal bridge heat-loss coefficient in W/K.
    """
...
print("Batch cleanup H complete.")